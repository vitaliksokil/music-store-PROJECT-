    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="discounts-items d-flex justify-content-around">
                <router-link :to="{name:'product-item',params:{id:product.id}}" class="discount-item-wrap" v-for="product in products">
                    ...
                    <div class="action align-self-center">
                        <ul class="d-flex justify-content-center">
                            <li @click.prevent="addToShoppingCart(product.id)"><i class="fas fa-shopping-basket"></i></li>
